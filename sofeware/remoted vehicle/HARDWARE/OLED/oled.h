...
#define OLED_D0_OL		GPIO_ResetBits(OLED_GPIOA, OLED_SCL)	//D0 IO口输出低电平
#define OLED_D0_OH		GPIO_SetBits(OLED_GPIOA, OLED_SCL)  	//D0 IO口输出高电平
...
#define OLED_SCLK_Clr() GPIO_ResetBits(OLED_GPIOA, OLED_SCL)	//D0 IO口输出低电平
#define OLED_SCLK_Set() GPIO_SetBits(OLED_GPIOA, OLED_SCL)  	//D0 IO口输出高电平
